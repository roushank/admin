        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">EDIT Configuration </h3> </div>
                                ...
                                <div class="input-states">
                                    ...
                                    <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                 <input type="text" name='app_title' value='<?php echo $row['title'] ?>' required class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" name='app_stitle' value='<?php echo $row['short_title'] ?>' required class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" name='app_logo' value='<?php echo $row['logo'] ?>' required class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" name='app_curreny_code' value='<?php echo $row['currency_code'] ?>' required class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                      ...
                                      <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                <input type="text" name='app_currency_symbol' value='<?php echo $row['currency_symbol'] ?>' required class="form-control">
                                                </div>
                                            </div>
                                        </div>                                        
